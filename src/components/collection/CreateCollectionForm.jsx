...
export default function CreateCollectionForm() {
    const {createCollection,loading,setLoading}= useCollectionStore(useShallow(state => ({
        ...
        <form className='flex flex-col py-4 px-16 justify-center w-2/3 max-xl:w-2/3 max-lg:w-3/4 max-md:w-full max-md:flex-col max-2xl:w-1/2 shadow-xl bg-white gap-8 rounded-xl'
            ...
            <div className='flex gap-2'>
                <div className='flex justify-center items-center'>
                    <AddPhoto file={input.file} setInput={setInput} className="flex justify-center items-center bg-sub hover:bg-slate-200 w-[160px] h-[160px] max-lg:w-[120px] max-lg:h-[120px]  rounded-lg relative cursor-pointer border" />
                </div>
